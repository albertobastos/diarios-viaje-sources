...
private: false
---
Hay días que, debido a la previsión meteorológica, puede anticiparse que no van a coronarse como los mejores del viaje. Hoy sería uno de ellos, pero de cada jornada se pueden rescatar cosas por aquí y por allá que merezca la pena recordar. Es el día en el que abandonamos Jasper y el coqueto apartamento de [Accommodations Jasper](http://www.accommodationsjasper.com/) que nos ha acogido durante dos noches. En el horizonte nos espera el basto [Parque Nacional de Banff](https://es.wikipedia.org/wiki/Parque_nacional_Banff). Y entre un lugar y el otro la [Icefields Parkway](https://es.wikipedia.org/wiki/Icefields_Parkway) o Carretera de los campos de hielo, una ruta escénica considerada una atracción en sí misma gracias a la gran cantidad de accesos que habilita a cataratas, lagos y glaciares a lo largo de su extensión. Con nueve grados y un cielo pintado de gris cuando salimos a las 8:40, nuestras esperanzas de disfrutarla tal y como merece son escasas.

![Adiós, Accommodations Jasper](R19D0401)
![La cosa no pinta bien...](R19D0402)
![Esta vez solo vemos el Skytram desde aquí](R19D0403)

Tan solo media hora después estamos ya apuntando nuestro primer fracaso. Detenemos el motor en el aparcamiento de las [Athabasca Falls](https://www.world-of-waterfalls.com/waterfalls/canada-athabasca-falls/), desierto dadas las circunstancias. Lejos de amainar, el diluvio parece ir a más y solo me plantearía calarme hasta los huesos si no hubiéramos visto estas abundantes cascadas tres años atrás. Pero ya las visitamos, así que la tentación no es tal y preferimos sucumbir ante la evidencia de que revisitarlas no sería una experiencia agradable en estas condiciones. Haciendo planes mentalmente de cómo aprovechar el día en Banff si el tiempo no mejora y apenas hacemos paradas durante la ruta, reemprendemos la marcha.
...
![Como diría Broncano: ¡Osoooo!](R19D0404)
![¿A qué sabrá esto?](R19D0405)

Nuestra siguiente parada es en el aparcamiento que hace las funciones de balcón hacia el [Stutfield Glacier](https://thegate.boardingarea.com/stutfield-glacier-at-columbia-icefield/). Nos encontramos un par de simpáticos cuervos expectantes ante las visitas pero de la lengua glaciar no hay ni rastro.

![Está el día flojo, José Manué](R19D0406)
![El Stutfield ni está ni se le espera](R19D0407)

Pasamos sin apenas aminorar la marcha junto al [Athabasca Glacier](https://es.wikipedia.org/wiki/Glaciar_Athabasca), dejando a mano izquierda el hotel [Glacier View](https://www.banffjaspercollection.com/hotels/glacier-view-lodge/ "Hotel Glacier View Lodge, frente al Athabasca Glacier") en el que pasamos una nada barata noche [a nuestro paso](/viajes/2016canada/08_icefields_parkway_athabasca_tangle_creek_falls_parker_ridge.html "Estancia en el Glacier View Lodge en 2016") en 2016. Se trata de una lengua glaciar descomunal pero tan descaradamente explotada que el color gris oscuro que ha tomado el hielo en sus cotas más bajas debido a las cientos de incursiones para grupos turísticos que se realizan a lo largo del año lo deslucen demasiado. Si quieres caminar sobre un glaciar y no te importa pagar sumas nada despreciables por ello, este es tu lugar. Para nosotros ese debate ya pasó.

Pasamos también de largo, y este es el cambio de planes que más nos duele, los aparcamientos para las subidas a [Parker Ridge](https://en.wikipedia.org/wiki/Parker_Ridge) y [Wilcox Pass](http://www.hikejasper.com/Hiking-Wilcox-Pass-in-Jasper.html). La primera es la excursión que premia con vistas a uno de los lugares favoritos de L en todo el mundo que llevamos visitado, y la segunda un ascenso que no realizamos en nuestra anterior visita y cuyas vistas teníamos muchas ganas de descubrir. Sin aminorar la marcha al superar sus desvíos, especulamos ya con cómo podemos encajar en nuestra agenda para los próximos días las 4 horas entre ida y vuelta que nos costaría volver hasta aquí.

Cruzamos el límite entre los Parques Nacionales de Jasper y Banff. Aquí el cielo parece ganar algo de brillo, dándonos esperanzas de que quizás no esté todo perdido. Las montañas con formas agresivas luchan contras las nubes, dejando entrever en algunos calros sus negras paredes moteadas con bloques de hielo. Cuando llegamos al desvío hacia [Peyto Lake](https://es.wikipedia.org/wiki/Lago_Peyto), uno de los lugares de visita obligada en Banff, decidimos darle una oportunidad.
...
![No es la mejor foto posible, pero es mejor de la que podíamos esperar](R19D0414)

Sin más paradas previstas, deshacemos los kilómetros de Bow Valley Parkway y nos reenganchamos a la Transcanadian Highway para dirigirnos ya sin más distracciones a la ciudad de [Banff](https://es.wikipedia.org/wiki/Banff "Banff, Alberta"). Con mucho tráfico y de nuevo cielos oscuros, alcanzamos el corazón de la turística ciudad con aires suizos a las 15:00.
...
![Paseando por la lluviosa Banff](R19D0416)
![Me quedé un poco con las ganas](R19D0417)
