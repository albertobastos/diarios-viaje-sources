...
export default ({ data }) => (
  <Layout>
    ...
    <div className="w3-container w3-content w3-center w3-padding-32 custom-max-width-800">
      <p className="w3-justify">Bienvenido a nuestro diario de viaje a las <strong>Montañas Rocosas canadienses</strong> y sus alrededores durante agosto y septiembre de 2019.</p>
      <p className="w3-justify">Durante dos semanas recorrimos parte de las provincias de la<strong>Columbia Británica</strong> y <strong>Alberta</strong> en Canadá, para finalizar con una visita al <strong>Glacier National Park</strong> en el estado de Montana en Estados Unidos.</p>
