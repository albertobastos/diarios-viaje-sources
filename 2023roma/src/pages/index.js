...
export default ({ data }) => (
  <Layout>
    ...
    <div className="w3-container w3-content w3-center w3-padding-32 custom-max-width-800">
      <p className="w3-justify">Relato de un viaje de cuatro días a la ciudad de <strong>Roma</strong>.</p>
      <p className="w3-justify">Mucho texto, muchas fotos y mucha comida, especialmente de helados.</p>
